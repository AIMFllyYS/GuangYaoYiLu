...
export const slide = defineSlide({
  ...
  elements: [
    image({ id: "bg-image", morphKey: "!!section-bg", name: "章节背景", asset: new URL("../../assets/generated/bg-030-ending.jpg", import.meta.url).href, alt: "无文字生成背景", x: 0, y: 0, w: 1920, h: 1080, opacity: 1, rotate: 0, z: 0, style: {"objectFit":"cover"} }),
    ...
    image({ id: "icon-1", morphKey: "!!icon-1", name: "主题图标 1", asset: new URL("../../assets/icons/film.svg", import.meta.url).href, alt: "film", x: 820, y: 454, w: 56, h: 56, opacity: 1, rotate: 0, z: 28, style: {"objectFit":"contain","borderRadius":14} }),
    image({ id: "icon-2", morphKey: "!!icon-2", name: "主题图标 2", asset: new URL("../../assets/icons/light.svg", import.meta.url).href, alt: "light", x: 896, y: 454, w: 56, h: 56, opacity: 1, rotate: 0, z: 28, style: {"objectFit":"contain","borderRadius":14} }),
    ...
    image({ id: "photo-1", morphKey: "!!photo-strip-01", name: "照片流 1", asset: new URL("../../assets/photos/cover-photo-a.jpg", import.meta.url).href, alt: "活动照片 1", x: 1166, y: 320, w: 270, h: 168, opacity: 0.94, rotate: -6, z: 16, style: {"objectFit":"cover","borderRadius":26,"shadow":"0 20px 50px rgba(0,0,0,.24)"} }),
    image({ id: "photo-2", morphKey: "!!photo-strip-02", name: "照片流 2", asset: new URL("../../assets/photos/carnival-photo-a.jpg", import.meta.url).href, alt: "活动照片 2", x: 1444, y: 320, w: 270, h: 168, opacity: 0.94, rotate: 5, z: 17, style: {"objectFit":"cover","borderRadius":26,"shadow":"0 20px 50px rgba(0,0,0,.24)"} }),
    image({ id: "photo-3", morphKey: "!!photo-strip-03", name: "照片流 3", asset: new URL("../../assets/photos/museum-photo-b.jpg", import.meta.url).href, alt: "活动照片 3", x: 1224, y: 520, w: 270, h: 168, opacity: 0.94, rotate: 4, z: 18, style: {"objectFit":"cover","borderRadius":26,"shadow":"0 20px 50px rgba(0,0,0,.24)"} }),
    image({ id: "photo-4", morphKey: "!!photo-strip-04", name: "照片流 4", asset: new URL("../../assets/photos/winter-talk-a.jpg", import.meta.url).href, alt: "活动照片 4", x: 1502, y: 520, w: 270, h: 168, opacity: 0.94, rotate: -4, z: 19, style: {"objectFit":"cover","borderRadius":26,"shadow":"0 20px 50px rgba(0,0,0,.24)"} }),
    image({ id: "photo-5", morphKey: "!!photo-strip-05", name: "照片流 5", asset: new URL("../../assets/photos/volunteer-photo-b.jpg", import.meta.url).href, alt: "活动照片 5", x: 1166, y: 720, w: 270, h: 168, opacity: 0.94, rotate: -3, z: 20, style: {"objectFit":"cover","borderRadius":26,"shadow":"0 20px 50px rgba(0,0,0,.24)"} }),
    image({ id: "photo-6", morphKey: "!!photo-strip-06", name: "照片流 6", asset: new URL("../../assets/photos/team-photo-pharmacy.jpg", import.meta.url).href, alt: "活动照片 6", x: 1444, y: 720, w: 270, h: 168, opacity: 0.94, rotate: 3, z: 21, style: {"objectFit":"cover","borderRadius":26,"shadow":"0 20px 50px rgba(0,0,0,.24)"} }),
