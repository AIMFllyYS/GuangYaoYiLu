...
export const slide = defineSlide({
  ...
  elements: [
    ...
    line({ id: "gold-path", morphKey: "!!gold-path", name: "????", x: 140, y: 810, w: 1480, h: 0, rotate: -1, opacity: 0.75, z: 4, style: {"stroke":"rgba(216,180,90,.74)","strokeWidth":4} }),
    ...
    image({ id: "icon-1", morphKey: "!!icon-1", name: "????", asset: asset("icons/light.svg"), alt: "????", x: 160, y: 466, w: 58, h: 58, opacity: 1, rotate: 0, z: 25, style: {"objectFit":"contain","borderRadius":16} }),
    ...
    rect({ id: "card-1", morphKey: "!!theme-card-1", name: "??? ??", x: 154, y: 560, w: 430, h: 96, z: 12, style: {"fill":"rgba(244,239,226,.08)","stroke":"rgba(216,180,90,.42)","strokeWidth":2,"borderRadius":24} }),
    text({ id: "card-title-1", morphKey: "!!card-title-2-1", name: "?????", content: `??`, x: 178, y: 576, w: 380, h: 30, z: 26, style: {"fontSize":24,"color":"#d8b45a","fontWeight":820} }),
    text({ id: "card-copy-1", morphKey: "!!card-copy-2-1", name: "?????", content: `????????`, x: 178, y: 610, w: 380, h: 32, z: 26, style: {"fontSize":21,"color":"#f7fbff","lineHeight":1.25,"fontWeight":620} }),
    rect({ id: "card-2", morphKey: "!!theme-card-2", name: "??? ??", x: 634, y: 560, w: 430, h: 96, z: 12, style: {"fill":"rgba(244,239,226,.08)","stroke":"rgba(216,180,90,.42)","strokeWidth":2,"borderRadius":24} }),
    text({ id: "card-title-2", morphKey: "!!card-title-2-2", name: "?????", content: `??`, x: 658, y: 576, w: 380, h: 30, z: 26, style: {"fontSize":24,"color":"#d8b45a","fontWeight":820} }),
    text({ id: "card-copy-2", morphKey: "!!card-copy-2-2", name: "?????", content: `?????????`, x: 658, y: 610, w: 380, h: 32, z: 26, style: {"fontSize":21,"color":"#f7fbff","lineHeight":1.25,"fontWeight":620} }),
    rect({ id: "card-3", morphKey: "!!theme-card-3", name: "??? ??", x: 154, y: 688, w: 430, h: 96, z: 12, style: {"fill":"rgba(244,239,226,.08)","stroke":"rgba(216,180,90,.42)","strokeWidth":2,"borderRadius":24} }),
    text({ id: "card-title-3", morphKey: "!!card-title-2-3", name: "?????", content: `??`, x: 178, y: 704, w: 380, h: 30, z: 26, style: {"fontSize":24,"color":"#d8b45a","fontWeight":820} }),
    text({ id: "card-copy-3", morphKey: "!!card-copy-2-3", name: "?????", content: `??????????`, x: 178, y: 738, w: 380, h: 32, z: 26, style: {"fontSize":21,"color":"#f7fbff","lineHeight":1.25,"fontWeight":620} }),
    rect({ id: "card-4", morphKey: "!!theme-card-4", name: "??? ??", x: 634, y: 688, w: 430, h: 96, z: 12, style: {"fill":"rgba(244,239,226,.08)","stroke":"rgba(216,180,90,.42)","strokeWidth":2,"borderRadius":24} }),
    text({ id: "card-title-4", morphKey: "!!card-title-2-4", name: "?????", content: `??`, x: 658, y: 704, w: 380, h: 30, z: 26, style: {"fontSize":24,"color":"#d8b45a","fontWeight":820} }),
    text({ id: "card-copy-4", morphKey: "!!card-copy-2-4", name: "?????", content: `???????????`, x: 658, y: 738, w: 380, h: 32, z: 26, style: {"fontSize":21,"color":"#f7fbff","lineHeight":1.25,"fontWeight":620} }),
    image({ id: "photo-1", morphKey: "!!photo-strip-01", name: "???", asset: asset("photos/cover-photo-a.jpg"), alt: "???", x: 1210, y: 392, w: 530, h: 360, opacity: 0.92, rotate: -2, z: 16, style: {"objectFit":"cover","borderRadius":26,"shadow":"0 20px 50px rgba(0,0,0,.22)"} }),
    ...
    text({ id: "page-index", morphKey: "!!page-index", name: "??", content: `02 / 30`, x: 1580, y: 1000, w: 190, h: 34, z: 27, style: {"fontSize":22,"color":"rgba(223,246,229,.72)","textAlign":"right","fontWeight":750} })
  ]
});
