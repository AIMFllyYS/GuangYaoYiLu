...
export const slide = defineSlide({
  ...
  elements: [
    ...
    line({ id: "gold-path", morphKey: "!!gold-path", name: "????", x: 175, y: 845, w: 1480, h: 0, rotate: 5, opacity: 0.75, z: 4, style: {"stroke":"rgba(216,180,90,.74)","strokeWidth":4} }),
    ...
    image({ id: "icon-1", morphKey: "!!icon-1", name: "????", asset: asset("icons/policy.svg"), alt: "????", x: 160, y: 466, w: 58, h: 58, opacity: 1, rotate: 0, z: 25, style: {"objectFit":"contain","borderRadius":16} }),
    image({ id: "icon-2", morphKey: "!!icon-2", name: "????", asset: asset("icons/museum.svg"), alt: "????", x: 246, y: 466, w: 58, h: 58, opacity: 1, rotate: 0, z: 25, style: {"objectFit":"contain","borderRadius":16} }),
    ...
    image({ id: "icon-4", morphKey: "!!icon-4", name: "????", asset: asset("icons/light.svg"), alt: "????", x: 418, y: 466, w: 58, h: 58, opacity: 1, rotate: 0, z: 25, style: {"objectFit":"contain","borderRadius":16} }),
    ...
    text({ id: "card-title-1", morphKey: "!!card-title-9-1", name: "?????", content: `??`, x: 178, y: 576, w: 380, h: 30, z: 26, style: {"fontSize":24,"color":"#0f6b5f","fontWeight":820} }),
    text({ id: "card-copy-1", morphKey: "!!card-copy-9-1", name: "?????", content: `???????????`, x: 178, y: 610, w: 380, h: 32, z: 26, style: {"fontSize":21,"color":"#08110d","lineHeight":1.25,"fontWeight":620} }),
    ...
    text({ id: "card-title-2", morphKey: "!!card-title-9-2", name: "?????", content: `??`, x: 658, y: 576, w: 380, h: 30, z: 26, style: {"fontSize":24,"color":"#0f6b5f","fontWeight":820} }),
    text({ id: "card-copy-2", morphKey: "!!card-copy-9-2", name: "?????", content: `???????????`, x: 658, y: 610, w: 380, h: 32, z: 26, style: {"fontSize":21,"color":"#08110d","lineHeight":1.25,"fontWeight":620} }),
    ...
    text({ id: "card-title-3", morphKey: "!!card-title-9-3", name: "?????", content: `??`, x: 178, y: 704, w: 380, h: 30, z: 26, style: {"fontSize":24,"color":"#0f6b5f","fontWeight":820} }),
    text({ id: "card-copy-3", morphKey: "!!card-copy-9-3", name: "?????", content: `??????????????`, x: 178, y: 738, w: 380, h: 32, z: 26, style: {"fontSize":21,"color":"#08110d","lineHeight":1.25,"fontWeight":620} }),
    image({ id: "photo-1", morphKey: "!!photo-strip-01", name: "???", asset: asset("photos/museum-photo-c.jpg"), alt: "???", x: 1210, y: 392, w: 300, h: 190, opacity: 0.92, rotate: -2, z: 16, style: {"objectFit":"cover","borderRadius":26,"shadow":"0 20px 50px rgba(0,0,0,.22)"} }),
    image({ id: "photo-2", morphKey: "!!photo-strip-02", name: "???", asset: asset("photos/carnival-poster.jpg"), alt: "???", x: 1450, y: 392, w: 300, h: 190, opacity: 0.92, rotate: 2, z: 16, style: {"objectFit":"cover","borderRadius":26,"shadow":"0 20px 50px rgba(0,0,0,.22)"} }),
    ...
    text({ id: "page-index", morphKey: "!!page-index", name: "??", content: `09 / 30`, x: 1580, y: 1000, w: 190, h: 34, z: 27, style: {"fontSize":22,"color":"rgba(8,17,13,.58)","textAlign":"right","fontWeight":750} })
  ]
});
