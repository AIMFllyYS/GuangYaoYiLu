...
export const slide = defineSlide({
  ...
  elements: [
    ...
    line({ id: "gold-path", morphKey: "!!gold-path", name: "????", x: 180, y: 870, w: 1500, h: 0, rotate: -4, opacity: 0.72, z: 4, style: {"stroke":"rgba(216,180,90,.76)","strokeWidth":4} }),
    ...
    image({ id: "icon-4", morphKey: "!!icon-4", name: "????", asset: asset("icons/research.svg"), alt: "????", x: 416, y: 458, w: 58, h: 58, opacity: 1, rotate: 0, z: 25, style: {"objectFit":"contain","borderRadius":16} }),
    ...
    image({ id: "photo-1", morphKey: "!!photo-strip-01", name: "???", asset: asset("photos/museum-photo-c.jpg"), alt: "???", x: 1210, y: 380, w: 300, h: 190, opacity: 0.94, rotate: -2, z: 16, style: {"objectFit":"cover","borderRadius":26,"shadow":"0 20px 50px rgba(0,0,0,.22)"} }),
    ...
    text({ id: "page-index", morphKey: "!!page-index", name: "??", content: `20 / 30`, x: 1580, y: 1000, w: 190, h: 34, z: 27, style: {"fontSize":22,"color":"rgba(223,246,229,.72)","textAlign":"right","fontWeight":750} })
  ]
});
