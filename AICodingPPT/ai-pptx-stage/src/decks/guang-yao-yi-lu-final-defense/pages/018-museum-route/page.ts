...
export const slide = defineSlide({
  ...
  elements: [
    ...
    line({ id: "gold-path", morphKey: "!!gold-path", name: "????", x: 172, y: 798, w: 1500, h: 0, rotate: -8, opacity: 0.72, z: 4, style: {"stroke":"rgba(216,180,90,.76)","strokeWidth":4} }),
    ...
    image({ id: "icon-2", morphKey: "!!icon-2", name: "????", asset: asset("icons/route.svg"), alt: "????", x: 244, y: 458, w: 58, h: 58, opacity: 1, rotate: 0, z: 25, style: {"objectFit":"contain","borderRadius":16} }),
    image({ id: "icon-3", morphKey: "!!icon-3", name: "????", asset: asset("icons/leaf.svg"), alt: "????", x: 330, y: 458, w: 58, h: 58, opacity: 1, rotate: 0, z: 25, style: {"objectFit":"contain","borderRadius":16} }),
    ...
    text({ id: "page-index", morphKey: "!!page-index", name: "??", content: `18 / 30`, x: 1580, y: 1000, w: 190, h: 34, z: 27, style: {"fontSize":22,"color":"rgba(223,246,229,.72)","textAlign":"right","fontWeight":750} })
  ]
});
