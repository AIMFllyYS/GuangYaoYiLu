...
- PPTX：`答辩PPT_v5/光药医路_5分钟稳定答辩PPT_v5.pptx`
- 静态预览 PDF：`答辩PPT_v5/光药医路_5分钟稳定答辩PPT_v5_静态预览.pdf`
...
- 讲稿：`答辩PPT_v5/光药医路_5分钟答辩讲稿_v5.md`

## 已执行检查

- 生成脚本：`python 工具/create_defense_ppt_v5_stable.py`
- PPTX 包结构：`python 工具/validate_pptx_package.py 答辩PPT_v5/光药医路_5分钟稳定答辩PPT_v5.pptx --expected-slides 22`
